...
public class ThreadedMethodContainerFetch implements Runnable 
{
	...
	public void extractClassId(String methodId)	//to store class name and exact method name as ivars
	{
	...
	public void extractExactClassName(String methodId)	//to store class name and exact method name as ivars
	{
		if (methodId.endsWith("<clinit>"))
		{
